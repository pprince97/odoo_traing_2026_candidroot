...
class VehicleBookingLine(models.Model):
    ...
    vehicle_id = fields.Many2one('product.product',string="Vehicle IDs")
    ...
    booking_rent_date = fields.Datetime(string="Booking Return Date",related="booking_id.rent_date")
