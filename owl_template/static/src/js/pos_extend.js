...
export class InformationPopup extends Component {
    static template = "InformationPopup";
    ...
    async confirm() {
        ...
        // const order = this.pos.getOrder();
        // const existingNote = order.getGeneralCustomerNote() || "";
        // const newNote = existingNote + " Man Patel";
        // order.setGeneralCustomerNote(newNote);
        // console.log("============>", newNote);
        //  // Dialog service provides the close prop
    }
